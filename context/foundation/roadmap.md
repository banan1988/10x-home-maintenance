...
| S-07 | `unified-visual-theme`          | see one consistent visual theme (colors, buttons, dialogs) across every page             | —             | MS-04                                                         | done   |
...
| S-04       | `home-maintenance-landing-page` | Write a real landing page, replacing the starter template    | —                     | Done — shipped 2026-09-14                                                           |
