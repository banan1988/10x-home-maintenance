...
const generatedTypesConfig = tseslint.config({
  ...
  rules: {
    // Supabase's own `supabase gen types typescript` generator emits `[_ in never]: never` for every
    // empty Views/Functions/CompositeTypes bucket — a false positive under this rule, not project code.
